    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state', models.CharField(choices=[('WAIT_FOR_MEDIA', 'Wait for Media'), ('BASIC', 'Basic State'), ('WAIT_FOR_EMAIL', 'Wait for Email')], default='BASIC')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('allowed_downloads_per_day', models.PositiveIntegerField(verbose_name='Allowed Downloads Per Day')),
