# Generated by Django 5.0 on 2023-12-13 09:11
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('external_id', models.PositiveIntegerField(unique=True, verbose_name='Profile ID')),
                ...
                ('state', models.CharField(choices=[('BASIC', 'Basic State'), ('WAIT_FOR_EMAIL', 'Wait for Email')], default='BASIC')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='contacts', to='ugc.profile')),
            ],
            options={
