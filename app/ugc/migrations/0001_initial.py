    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('telegram_video_file_id', models.CharField(max_length=255, unique=True, verbose_name='Telegram Video File ID')),
                ('telegram_audio_file_id', models.CharField(max_length=255, unique=True, verbose_name='Telegram Audio File ID')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state', models.CharField(choices=[('WAIT_FOR_EMAIL', 'Wait for Email'), ('BASIC', 'Basic State'), ('WAIT_FOR_MEDIA', 'Wait for Media')], default='BASIC')),
            ],
            options={
